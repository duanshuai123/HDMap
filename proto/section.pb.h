...
class Section : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hdmap_proto.Section) */ {
 public:
  Section();
  virtual ~Section();
  ...
  static const LaneDirection UN_KNOWN =
    Section_LaneDirection_UN_KNOWN;
  static const LaneDirection FORWARD =
    Section_LaneDirection_FORWARD;
  static const LaneDirection BACKWARD =
    Section_LaneDirection_BACKWARD;
  static const LaneDirection TWOWAY =
    Section_LaneDirection_TWOWAY;
  ...
  ::hdmap_proto::Section_LaneDirection direction() const;
  void set_direction(::hdmap_proto::Section_LaneDirection value);

  // repeated .hdmap_proto.Lane lanes = 3;
  int lanes_size() const;
  void clear_lanes();
  static const int kLanesFieldNumber = 3;
  const ::hdmap_proto::Lane& lanes(int index) const;
  ::hdmap_proto::Lane* mutable_lanes(int index);
  ::hdmap_proto::Lane* add_lanes();
  ...
  int pred_indices_size() const;
  void clear_pred_indices();
  static const int kPredIndicesFieldNumber = 10;
  ::google::protobuf::uint32 pred_indices(int index) const;
  void set_pred_indices(int index, ::google::protobuf::uint32 value);
  void add_pred_indices(::google::protobuf::uint32 value);
  ...
  int succ_indices_size() const;
  void clear_succ_indices();
  static const int kSuccIndicesFieldNumber = 11;
  ::google::protobuf::uint32 succ_indices(int index) const;
  void set_succ_indices(int index, ::google::protobuf::uint32 value);
  void add_succ_indices(::google::protobuf::uint32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      succ_indices() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
