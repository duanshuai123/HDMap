...
class Lane : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hdmap_proto.Lane) */ {
 public:
  Lane();
  virtual ~Lane();
  ...
  const ::hdmap_proto::CurveLine& lines(int index) const;
  ::hdmap_proto::CurveLine* mutable_lines(int index);
  ::hdmap_proto::CurveLine* add_lines();
